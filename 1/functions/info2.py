"""info2.py: Mouduł zawiera funkcję do pliku main.py, pozwalające na jego obsłge"""
...
def family_data(imie_zony, nazwisko_zony, liczba_dzieci, **lst_dzieci):
    ...
    Args:
        ...
        :param kwargs: (str, list), (imiona dzieci)
    Returns:
        Zdanie wypełnione zmiennymi (str, int)
    """
    while True:
        try:
            print('Imie żony: {}, nazwisko żony: {}, '
                  'liczba dzieci: {}, imiona dzieci:'.format(imie_zony, nazwisko_zony, liczba_dzieci))
            for key, value in lst_dzieci.items():
